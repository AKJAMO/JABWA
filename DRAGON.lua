...
send(msg.chat_id_, msg.id_,' ⦁ اصدار سورس جولد{ S:12✓}')
end
...
local Text = [[ 
[قناه سورس جولد ادخل وتابع الجديد](t.me/Soon_ban)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
if text == 'باندظا' or text == 'Baظnda' or text == 'baدnda' then
local Text = [[
المبرمج باندا لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
